...
CREATE TABLE `sys_carousel`  (
  ...
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `imgPath` varchar(50) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NOT NULL,
  PRIMARY KEY (`carousel_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_classify`  (
  ...
  `classify` varchar(30) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NOT NULL,
  `path` varchar(30) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NOT NULL,
  PRIMARY KEY (`bid`) USING BTREE,
  UNIQUE INDEX `bid`(`bid` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_comment`  (
  ...
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NOT NULL COMMENT '评论信息',
...
CREATE TABLE `sys_log`  (
  ...
  `user_name` varchar(50) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NOT NULL,
  `ip` varchar(50) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `sys_notice`  (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '公告标头',
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '公告详情描述',
...
CREATE TABLE `sys_order`  (
  ...
  `order_code` varchar(30) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NOT NULL,
  `user_id` int(20) NOT NULL,
  `product_id` int(20) NOT NULL,
  `bycount` int(10) NOT NULL DEFAULT 1,
  `state` varchar(50) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '未支付',
...
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_product`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `product_name` varchar(50) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NOT NULL,
  `product_author` varchar(50) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NOT NULL,
  `classimg` varchar(100) CHARACTER SET utf8 COLLATE utf8mb3_general_ci NOT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 91 CHARACTER SET = utf8 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
